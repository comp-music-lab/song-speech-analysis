...
CONCEPT_NAME <- c('Timbral noisiness', 'Temporal rate', 'Pitch range', 'Intensity', 'Rhythmic regularity', 'Pitch height', 'Pitch declination', 'Phrase length', 'Pitch interval regularity', 'Pitch stability', 'Pitch interval size', 'Timbral brightness', 'Pulse clarity')
