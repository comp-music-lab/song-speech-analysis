...
## Exploratory analysis - Mean feature values [Ours]
rm(list = ls())
INPUTDIR <- './output/analysis/Stage2/'
...
## Exploratory analysis - Meta-analysis [Hilton and ours]
rm(list = ls())
OUTPUTDIR <- "./output/figure/Stage2/"
source("plot_mixES.R")

## Exploratory analysis - Mean feature values [Hilton vs. ours]
rm(list = ls())
